...
def alterna_level():
    ...
    enemy = DeathBar(270, 157, 45, 150)
    enemy2 = DeathBar(370, 250, 45, 190)
    ...
    def draw():
        ...
        nivelAtual = font.render("NIVEL: " +str(3), False, (255,255,0))
