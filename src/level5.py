...
def alterna_level():
    ...
    def update():
        ...
        #TESTE DE COLISAO
        if player.draw(tela).collidelist([enemy.draw(tela), enemy2.draw(tela)]) != -1:#teste de colisao
            fail_sound.play()
    ...
    def draw():
        ...
        nivelAtual = font.render("NIVEL: " +str(5), False, (255,255,0))
