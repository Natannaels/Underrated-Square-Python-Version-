...
def alterna_level():
    ...
    enemy = DeathBar(220, 280,  310, 100)
    enemy2 = DeathBar(220, 100,  310, 100)
    enemy3 = DeathBar(270, 157, 75, 110)
    enemy4 = DeathBar(270, 320, 75, 110)
    ...
    def update():
        ...
        #TESTE DE COLISAO
        if player.draw(tela).collidelist([enemy.draw(tela), enemy2.draw(tela), enemy3.draw(tela), enemy4.draw(tela)]) != -1:#teste de colisao
            fail_sound.play()
    ...
    def draw():
        ...
        nivelAtual = font.render("NIVEL: " +str(6), False, (255,255,0))
