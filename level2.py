...
def alterna_level():
    ...
    enemy = DeathSphere(375, 245, 45, 45, )
    enemy2 = DeathSphere(270, 350, 45, 45)
    enemy4 = DeathSphere(483, 350, 45, 45)
    deathbar1 = DeathBar(110,400,530,30)
    deathbar2 = DeathBar(110,160,530,30)
    ...
    def update():
        ...
        player.move(keys)
        enemy.move2(245,350)
        enemy2.move2(245, 350)
        enemy4.move2(245, 350)

        if player.draw(tela).collidelist([enemy.draw(tela), enemy2.draw(tela), enemy4.draw(tela),deathbar2.draw(tela),deathbar1.draw(tela)]) != -1:#teste de colisao
            fail_sound.play()
            player.reset()
            player.mortes +=1
            player.vidas -=1
    ...
    def draw():
        ...
        nivelAtual = font.render("NIVEL: " +str(2), False, (255,255,0))
